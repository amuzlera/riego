...
async def _main_loop():
    ...
    try:
        from boot_manager import mark_boot_success
    ...
    while True:
        try:
            ...
            try:
                ...
                pass
            if failures >= MAIN_FAILURE_LIMIT:
                try:
                    from boot_manager import log

                    log("Demasiados fallos consecutivos en main, reiniciando")
                except Exception:
                    pass
                try:
                    import machine
...
async def _watchdog_loop():
    ...
    await monitor(required=("main", "scheduler", "server"))
